...
def open_paramPage(browser):
    ...
    param_input = browser.find_element(By.XPATH, "//span[contains(text(),'TEMP')]/../mat-form-field/div/div/div/input")
    return param_input
def test_ParaPage(browser):
    ...
    browser.find_element(By.XPATH, "//span[text()=' OK ']/..").click()
    assert MainPage(browser).is_element_showed("#audit-dialog") is True
    browser.find_element(By.XPATH, "//span[text()='Cancel']/..").click()
    ...
    Common(browser).eleclick(check_box)
    # browser.find_element(By.XPATH, "////*[@id='audit-dialog']/div/div[2]/mat-checkbox/label/div/input").click()
    browser.find_element(By.XPATH, "//span[text()='OK']/..").click()
    time.sleep(2)
